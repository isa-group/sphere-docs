---
sidebar_position: 4
title: 👮‍♂️ Pricing-driven access control
custom_edit_url: null
---

# 👮‍♂️ Pricing-driven access control


Welcome to the SPACE tutorial! 🚀 It is designed to **guide you step by step through the integration of SPACE** into a real SaaS-like system.  
In this lab, we’ll take a simple *news application* and progressively enhance it with **pricing-driven self-adaptation** — demonstrating how SPACE enables feature control, usage monitoring, and dynamic UI adaptation in real time.

This laboratory serves as both a **technical introduction** to SPACE and a **practical exercise** for those who want to understand how its core concepts work in an actual software environment.

You can follow the detailed written instructions below, or, if you prefer a more guided experience, you can watch our complete **video tutorial** where the full lab is solved step by step:

<iframe width="100%" height="450" src="https://www.youtube.com/embed/y_YCGQRUP8k" title="SPACE Laboratory Tutorial" frameborder="0" allowfullscreen></iframe>

By the end of this lab, you will have:
- A fully functional application integrated with SPACE.
- A clear understanding of how pricing models can drive self-adaptation.
- The foundational knowledge to integrate SPACE into your own systems.

:::tip
If you are interesting in learning more about SPACE, you can also check its [official documentation](../api/space/introduction.mdx) and the [GitHub repository](https://github.com/isa-group/space).
:::
...
![News Pricing](../static/img/tutorials/news-pricing-v1.png)
...
:::info
The SPACE repository is available at [https://github.com/isa-group/space](https://github.com/isa-group/space)
:::
...
:::warning
This laboratory was only tested using **pnpm** to run both the backend and the frontend concurrently.
...
:::info Note
💡 It’s normal for some parts of the application to fail or show temporary errors until all configuration steps are completed.  
...
:::info What is this middleware doing?
...
This software is licensed under the **MIT License**. See the [LICENSE](https://github.com/Alex-GF/space-tutorial/blob/main/LICENSE) file for more details.
