...
:::warning
This documentation only applies to **SPACE versions 0.3.0 and earlier**.
If you are using **SPACE 1.0.0 or later**, please refer to the [SPACE >= 1.0.0 User Guide](../SPACE-1.0.0/introduction.md) instead.
:::
