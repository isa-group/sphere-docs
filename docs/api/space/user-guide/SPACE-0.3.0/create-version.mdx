...
![Add pricing version button](../../../../static/img/space/user-guides/<1.0.0/add-pricing-version.png)
...
![Add version dialog](../../../../static/img/space/user-guides/<1.0.0/add-new-version-dialog.png)
