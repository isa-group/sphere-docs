...
- The service will **no longer appear in the list of services** of the organization.  
...
1. Go to the **Services Management** tab in the left sidebar and select the service you want to update (in this example, **PetClinic**).

![Services Management View](../../../../static/img/space/user-guides/>=1.0.0/services-management-with-service.png)

2. Click on the **service card** to open its details. Here you’ll find the list of existing pricing versions for that service.

![Pricing Versions](../../../../static/img/space/user-guides/>=1.0.0/service-details-two-versions.png)

3. Click the **⋮ (three-dot menu)** at the top-right corner and select **Disable Service**. Then confirm the action.
