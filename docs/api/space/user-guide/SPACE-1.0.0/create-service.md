...
1. Log in into SPACE and select the organization you want to create the service in.

![Dashboard View](../../../../static/img/space/user-guides/>=1.0.0/dashboard-view.png)

2. Navigate to the **Services Management** tab on the left sidebar and click the **Add Service** button.

![Services Management](../../../../static/img/space/user-guides/>=1.0.0/services-management.png)

3. A dialog will appear prompting you to upload a YAML file.  

![Add Service dialog](../../../../static/img/space/user-guides/>=1.0.0/add-service-dialog.png)
...
![Service uploaded](../../../../static/img/space/user-guides/>=1.0.0/services-management-with-service.png)
...
Besides the SPACE UI, you can also create a service programmatically using the **SPACE API**. This is especially useful for automation workflows (e.g., CI/CD pipelines) where you want to upload or update pricings without manual intervention.

:::important
You will need an organization-level API key with, at least, `MANAGEMENT` scope, to authenticate your request. See [this guide](./retrieve-api-key.md) for more details on how to obtain one.
:::
...
```json
{
  "name": "Petclinic",
  "disabled": false,
  "organizationId": "a4f9c2d18b6e3a7f5c019e42",
  "activePricings": {
    "2025-3-26": {
