...
0. You must already have a service created in SPACE.  
  👉 If not, see [Create a Service](./create-service.md) first.

1. Go to the **Services Management** tab in the left sidebar.  

![Services Management with PetClinic](../../../../static/img/space/user-guides/>=1.0.0/services-management-with-service.png)

2. Select the service you want to update (in this example, **PetClinic**).

3. Click on the **service card** to open its details. Here you'll find the list of existing pricing versions for that service.

![Service details view](../../../../static/img/space/user-guides/>=1.0.0/service-details.png)

4. Click the **⋮ (three-dot menu)** at the top-right corner and select **Add Version**. A dialog will appear asking you to upload a **Pricing2Yaml** file.

![Add version dialog](../../../../static/img/space/user-guides/>=1.0.0/add-version-dialog.png)

:::tip
Alternatively, you can **upload your pricing to SPHERE** and use the link of the desired pricing
version to instantiate the service. See the [SPHERE version-management guide](../../../sphere/user-guides/08-explore-and-version-pricings.mdx) for more details.
:::
...
SPACE will create the new pricing version and automatically link it to your service. You'll see it appear in the **versions list** inside the service details page.

![Service details with new version](../../../../static/img/space/user-guides/>=1.0.0/service-details-two-versions.png)
