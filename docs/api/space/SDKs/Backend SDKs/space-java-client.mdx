...
## Quick Start in 5 Minutes (Spring)

### 1. Configure properties

Go to `application.properties` or `application.yml` and add:
...
### 2. Register Space client configuration
...
public class PricingService {
  ...
  public boolean canUseExport(String userId) {
    FeatureEvaluationResult result = spaceClient.features.evaluate(userId, "billing-export");
...
`SpaceClientAutoConfiguration` reads:

- `space.client.url`
- `space.client.api-key`
- `space.client.timeout` (default `10000`)

Because Spring resolves environment sources, you can also set:

- `SPACE_CLIENT_URL`
- `SPACE_CLIENT_API_KEY`
...
<TabItem value="java">
## Quick Start in 5 Minutes (Java Vanilla)
...
public class Main {
  public static void main(String[] args) {
    ...
    FeatureEvaluationResult result = client.features.evaluate("user-123", "serviceA-featureX");
...
## 📊 Data Models### SpaceConnectionOptions
