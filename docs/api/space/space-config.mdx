...
| `MONGO_URI`         | ❌       | `mongodb://${dbCredentials}localhost:27017/${dbName}` | Full MongoDB connection string                          |
| `REDIS_URL`         | ✅       | —                                                     | Redis URL for caching                                   |
| `JWT_SECRET`        | ✅       | —                                                     | Secret key for JWT generation                           |
| `JWT_SALT`          | ✅       | —                                                     | Salt for JWT hashing                                    |
...
| `VITE_SPACE_BASE_URL`      | ✅             | Base URL of the SPACE server                           |
